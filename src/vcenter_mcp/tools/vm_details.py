...
@mcp.tool()
@guard_tool("get_vm_guest_identity")
...
@mcp.tool()
@guard_tool("list_vm_guest_local_filesystems")
...
@mcp.tool()
@guard_tool("list_vm_guest_network_interfaces")
